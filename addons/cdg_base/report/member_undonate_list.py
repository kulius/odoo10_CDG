...
class MemberUndonateListXlsx(ReportXlsx):
    ...
    def generate_xlsx_report(self,workbook,data,env):
        ...
        for line in data['docs']:
            ...
            if not data:
                ...
                sheet.write(count, 0, data.new_coding)
                sheet.write(count, 1, data.name)
...
MemberUndonateListXlsx('report.cdg_base.member_undonate_list.xlsx', 'normal.p')
